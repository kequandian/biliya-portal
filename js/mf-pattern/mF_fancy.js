...
myFocus.pattern.extend({
	'mF_fancy':function(settings,$){
		...
		var $prevBtn=$focus.addHtml('<div class="prev"><a href="javascript:;"><img src="http://image.10mup.com/zi_01.png"></a></div>');
		var $nextBtn=$focus.addHtml('<div class="next"><a href="javascript:;"><img src="http://image.10mup.com/zi_02.png"></a></div>');
		var $picListArr=[];
		//CSS
